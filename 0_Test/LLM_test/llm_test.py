...
# my_project에 개요 작성
my_project = "비비의 밤양갱 노래 분석 프로젝트.\
              정말 비비가 먹고 싶었던 것은 밤양갱 한 개 뿐인가? 두 개가 먹고 싶었을 수도 있다.\
              헤어지는 상황 같은데 비비는 밤양갱 타령을 왜 하는 것인가? 마트 가서 사먹으면 해결될 일이 아닌가.\
              그녀는 밤양갱이 먹고 싶었던 것이 아니라라 밤양Gang(gangster)이었던 것이 아닌가."
